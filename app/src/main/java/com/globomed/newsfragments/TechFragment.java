...
public class TechFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) v.findViewById(R.id.tech_recyclerview);
    ...
    //Fetch the technology news using Volley and add them to the array
    private void topHeadlines() {

        String topHeadlinesUrl = "https://gnews.io/api/v4/top-headlines?&lang=en&topic=technology&token=494ecdb8399139e373cc23fe5386817f";
