...
public class SportsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.sports_fragment, container, false);

        mRecyclerView = (RecyclerView) v.findViewById(R.id.sports_recyclerview);
    ...
    //Fetch the sports news using Volley and add them to the array
    private void sportsNews() {

        String topHeadlinesUrl = "https://gnews.io/api/v4/top-headlines?&lang=en&topic=sports&token=494ecdb8399139e373cc23fe5386817f";
